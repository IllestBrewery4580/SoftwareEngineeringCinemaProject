<<<<<<< HEAD:Frontend/src/components/ResetPassword.js
'use client'
...
const ResetPassword = () => {
    ...
    const handleSubmit = async() => {
        try {
            const response = await fetch("/accounts/newpassword/", {
                method: "POST",
                headers: {
...
>>>>>>> dbandfrontend:Frontend/src/components/Account/ResetPassword.js
