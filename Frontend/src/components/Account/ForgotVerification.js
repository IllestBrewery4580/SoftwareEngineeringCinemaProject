<<<<<<< HEAD:Frontend/src/components/ForgotVerification.js
'use client'
        ...
        <div className= "flex justify-center">
            <div className="bg-white p-6 pb-2 rounded-lg shadow-md">
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                    <h1 className='font-bold text-center text-lg'>Verification</h1>
                </div>
                <div className="flex flex-col md:flex-row gap-4 mb-6">
...
>>>>>>> dbandfrontend:Frontend/src/components/Account/ForgotVerification.js
